...
export const demoWarning = async () => {
        ...
        <div className='panel-container'>
          <div>
            ...
            <ol>
              ...
              <button disabled onClick={() => {setInstructionCard(instructionCard === 'x' ? '' : 'x')}} className={instructionCard === 'x' ? 'highlighted' : ''}>X (Twitter) (coming soon)</button>&nbsp;
              {
                ...
                <Card toggleCard={() => {setInstructionCard('')}} title='Download your data from Google' content=
                {
                  <ol>
                    ...
                    <li>Select data you want to download (select all for a comprehensive review), then deselect <strong>Drive</strong> to reduce download size<br/><img src={require('../img/google1.png')} /></li>
              ...
              Use the <strong>Process your data downloads</strong> section below
          ...
          <div className='upload-container'>
            ...
            <div className='mt-2 mb-3'>
              <button onClick={demoWarning}>Upload file</button>
              {fileUploadStatus && 
            ...
            <div>
              ...
              {downloadFiles.length > 0 ? <div>
                ...
                <button onClick={demoWarning}>Clear all my data</button></div>:
